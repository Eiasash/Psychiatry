...
const checks = [
  ...
  [/api\/supabase-config/, "Supabase auth configuration gate"],
  [/auth\/v1\/token\?grant_type=password/, "Supabase password login"],
  [/auth\/v1\/signup/, "Supabase open signup"],
  [/study_progress/, "Supabase progress sync"],
  [/study_stars/, "Supabase stars sync"],
